  ...
  return (
    <div className='about'>
      ...
      <section className='cv code-look'>
        ...
        <h1>Experience</h1>
        <Experience company='israeli air force' title='fullstack developer' from={'April 2021'} to={'April 2022'} points={['Developed webapps in use by thousands of users', 'Integrated complex, multi interface and legacy programs', 'Used the MEAN stack with Azure for most projects']}/>
        ...
        <div><h2>For my CV: <Link to="/Daniel_Mikhailov.pdf" className='link' target="_blank" download>download</Link></h2></div>
      </section>
    </div>
  );
