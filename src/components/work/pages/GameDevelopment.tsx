  ...
  return (
    <div id='game development' className='game-development code-look'>
      ...
      <div className='game-development-projects'>
        ...
        <Project name='savana' link='https://github.com/dandeduck/savana' description='Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris lobortis dictum magna ut mattis. Nulla facilisi. Morbi ut neque orci. Suspendisse tortor metus, su' technologies={['Unity', 'RPG Systems']} />
        <Project name='savana' link='https://github.com/dandeduck/savana' description='Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris lobortis dictum magna ut mattis. Nulla facilisi. Morbi ut neque orci. Suspendisse tortor metus, su' technologies={['Unity', 'RPG Systems']} />
      </div>
    </div>
  );
